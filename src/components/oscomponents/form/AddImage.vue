              ...
              <v-card-text>
                <v-form ref="form" v-model="valid" lazy-validation>
                    <v-layout align-center>
                      <v-autocomplete
                        ref="country"
                        :rules="[() => !!imagetype || 'This image type is required']"
                        :items="imagetypes"
                        v-model="imagetype"
                        label="Image type"
...
<script>
  ...
  export default {
    data: () => ({
      ...
      idescriptions: '',
      imagetype: null,
      imagetypes: ['profile', 'gallery', 'menu'],
      valid: false,
      imagetitlefield: false,
      imagedescriptionfield: false
    }),
    watch: { 'imagetype': function () {
      let category = this.imagetype

      switch (category) {
        case 'profile':
          this.imagetitlefield = false
          this.imagedescriptionfield = false
          break
        case 'gallery':
          this.imagetitlefield = false
          this.imagedescriptionfield = true
          break
        case 'menu':
    ...
    methods: {
      ...
      upload () {
        ...
        const description = this.idescriptions
        ...
        this.cropimage.generateBlob((blob) => {
          ...
          local.$store.dispatch("addImage", imageData)
        })     
      }     
    }       
  }
